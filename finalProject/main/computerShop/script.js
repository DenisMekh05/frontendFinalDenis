...
for (let index in localUsers) {
    for (let computer in localUsers[index].computers) {
        if (computer.category == "Acer") {
            ...
            `
        } else if (computer.category == "Asus") {
            ...
            `
        } else if (computer.category == "Dell") {
            ...
            `
        } else if (computer.category == "Lenovo") {
            ...
            `
        } else if (computer.category == "Casper") {
            ...
            `
        } else if (computer.category == "Fujitsu") {
            ...
            `
        } else if (computer.category == "Nexus") {
            ...
            `
        } else if (computer.category == "Samsung") {
            ...
            `
        } else if (computer.category == "Tosbiha") {
            ...
            `
        } else if (computer.category == "Sony") {
